-- Restaurant Concierge Database Schema (Fixed)
...
DROP POLICY IF EXISTS "Users can view geofences for own locations" ON public.geofences;
DROP POLICY IF EXISTS "Users can manage geofences for own locations" ON public.geofences;
DROP POLICY IF EXISTS "Users can view automations for own locations" ON public.automations;
DROP POLICY IF EXISTS "Users can manage automations for own locations" ON public.automations;
DROP POLICY IF EXISTS "Users can view events for own locations" ON public.events;
...
CREATE POLICY "Users can insert geofences for own locations"
...
CREATE POLICY "Users can update geofences for own locations"
...
CREATE POLICY "Users can delete geofences for own locations"
...
CREATE POLICY "Users can insert automations for own locations"
...
CREATE POLICY "Users can update automations for own locations"
...
CREATE POLICY "Users can delete automations for own locations"
...
-- Allow service role to insert events (for backend/mobile app)
-- This allows the backend to insert events without authentication
